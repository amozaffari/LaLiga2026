...
ODDS_API_URL = "https://api.the-odds-api.com/v4/sports/soccer_spain_la_liga/odds"

# The Odds API spells clubs e.g. "Atlético Madrid", "Athletic Bilbao", "Real Betis",
# "Celta Vigo", "Deportivo La Coruña"; all resolve through the central alias table.
...
def parse_events(events: list) -> pd.DataFrame:
    ...
    rows = []
    for ev in events:
        home = canonical_team(ev["home_team"])
        away = canonical_team(ev["away_team"])
